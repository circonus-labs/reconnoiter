...
--
-- Name: tasklock_id_seq; Type: SEQUENCE; Schema: noit; Owner: reconnoiter
--
...
ALTER TABLE noit.tasklock_id_seq OWNER TO reconnoiter;

--
-- Name: tasklock_id_seq; Type: ACL; Schema: noit; Owner: reconnoiter
--
