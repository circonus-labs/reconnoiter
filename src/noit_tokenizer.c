/* Generated by re2c 0.13.2 on Tue Mar 17 15:37:18 2009 */
...
yy2:
		...
		goto yy17;
yy3:
#line 54 "noit_tokenizer.re"
		{ t->token = NULL;
                      t->end = t->next;
                      t->type = NT_SPACE;
                      return 1; }
#line 76 "noit_tokenizer.c"
yy4:
		++t->next;
#line 58 "noit_tokenizer.re"
		{ t->type = NT_DQSTRING;
                      if(t->start != t->end) {
                        t->start++;
                        t->end = t->next - 1;
...
#line 92 "noit_tokenizer.c"
yy6:
		++t->next;
#line 70 "noit_tokenizer.re"
		{ t->type = NT_IDENT;
                      if(t->start != t->end) {
                        t->start++;
                        t->end = t->next - 1;
...
#line 107 "noit_tokenizer.c"
yy8:
		++t->next;
		yych = (unsigned char)*t->next;
		goto yy13;
yy9:
#line 82 "noit_tokenizer.re"
		{ char only = ' ';
                      t->end = t->next;
                      t->type = NT_IDENT;
                      t->token = malloc(t->end-t->start + 1);
...
#line 95 "noit_tokenizer.re"


 sqstring:

#line 172 "noit_tokenizer.c"
	{
		unsigned char yych;
		yych = (unsigned char)*t->next;
		switch (yych) {
...
yy20:
#line 99 "noit_tokenizer.re"
		{ t->end = t->next;
                      goto mainpattern; }
#line 185 "noit_tokenizer.c"
yy21:
		++t->next;
		yych = (unsigned char)*t->next;
		switch (yych) {
...
yy29:
		++t->next;
#line 110 "noit_tokenizer.re"
		{ t->end = t->next--;
                      goto mainpattern;
                    }
#line 238 "noit_tokenizer.c"
yy31:
		++t->next;
#line 113 "noit_tokenizer.re"
		{ goto dqstring; }
#line 243 "noit_tokenizer.c"
yy33:
		++t->next;
#line 114 "noit_tokenizer.re"
		{ BAIL_UNKNOWN; }
#line 248 "noit_tokenizer.c"
yy35:
		++t->next;
#line 109 "noit_tokenizer.re"
		{ goto dqstring; }
#line 253 "noit_tokenizer.c"
yy37:
		++t->next;
#line 107 "noit_tokenizer.re"
		{ goto dqstring; }
#line 258 "noit_tokenizer.c"
	}
#line 115 "noit_tokenizer.re"
