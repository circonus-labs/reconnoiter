  ...
  while (1)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == T_STRING)
        {
          if ((ret = thrift_protocol_read_string (protocol, &this_object->checkModule, error)) < 0)
            return -1;
          xfer += ret;
          this_object->__isset_checkModule = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
          xfer += ret;
...
bundle_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "checkModule", T_STRING, 2, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_string (protocol, this_object->checkModule, error)) < 0)
    return -1;
  if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "target", T_STRING, 3, error)) < 0)
    return -1;
  xfer += ret;
  ...
  if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "available", T_BYTE, 5, error)) < 0)
    return -1;
  xfer += ret;
  ...
  if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "state", T_BYTE, 6, error)) < 0)
    return -1;
  xfer += ret;
  ...
  if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "duration", T_I32, 7, error)) < 0)
    return -1;
  xfer += ret;
  ...
  if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
    return -1;
  xfer += ret;
  if ((ret = thrift_protocol_write_field_begin (protocol, "timestamp", T_I64, 9, error)) < 0)
    return -1;
  xfer += ret;
  ...
  if (this_object->__isset_metrics == TRUE) {
    if ((ret = thrift_protocol_write_field_begin (protocol, "metrics", T_MAP, 10, error)) < 0)
      return -1;
    xfer += ret;
    {
...
bundle_instance_init (Bundle * object)
{
  ...
  object->checkModule = NULL;
  object->__isset_checkModule = FALSE;
  object->target = NULL;
