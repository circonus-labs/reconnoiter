...
PROTOBUF_NAMESPACE_OPEN
template <>
::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess>(Arena*);
template <>
::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest>(Arena*);
template <>
::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
