...
const ::uint32_t TableStruct_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto = {
    ...
    file_level_metadata_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto(&descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto);
namespace opentelemetry {
namespace proto {
namespace logs {
namespace v1 {
...
inline void ResourceLogs::SharedDtor() {
  ABSL_DCHECK(GetArenaForAllocation() == nullptr);
  _internal_mutable_scope_logs()->~RepeatedPtrField();
...
::uint8_t* ResourceLogs::_InternalSerialize(
  ...
  if (!this->_internal_schema_url().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "opentelemetry.proto.logs.v1.ResourceLogs.schema_url");
...
// @@protoc_insertion_point(message_byte_size_start:opentelemetry.proto.logs.v1.ResourceLogs)
  ...
  for (const auto& msg : this->_internal_scope_logs()) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void ResourceLogs::InternalSwap(ResourceLogs* other) {
  ...
  _internal_mutable_scope_logs()->InternalSwap(other->_internal_mutable_scope_logs());
...
inline void ScopeLogs::SharedDtor() {
  ABSL_DCHECK(GetArenaForAllocation() == nullptr);
  _internal_mutable_log_records()->~RepeatedPtrField();
  _impl_.schema_url_.Destroy();
...
::uint8_t* ScopeLogs::_InternalSerialize(
  ...
  if (!this->_internal_schema_url().empty()) {
    const std::string& _s = this->_internal_schema_url();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "opentelemetry.proto.logs.v1.ScopeLogs.schema_url");
    target = stream->WriteStringMaybeAliased(3, _s, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:opentelemetry.proto.logs.v1.ScopeLogs)
  ...
  for (const auto& msg : this->_internal_log_records()) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void ScopeLogs::InternalSwap(ScopeLogs* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  _internal_mutable_log_records()->InternalSwap(other->_internal_mutable_log_records());
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.schema_url_, lhs_arena,
                                       &other->_impl_.schema_url_, rhs_arena);
...
LogRecord::LogRecord(const LogRecord& from)
  ...
  if (!from._internal_severity_text().empty()) {
    _this->_impl_.severity_text_.Set(from._internal_severity_text(), _this->GetArenaForAllocation());
  }
...
::uint8_t* LogRecord::_InternalSerialize(
  ...
  if (!this->_internal_severity_text().empty()) {
    const std::string& _s = this->_internal_severity_text();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "opentelemetry.proto.logs.v1.LogRecord.severity_text");
    target = stream->WriteStringMaybeAliased(3, _s, target);
  }
  ...
  if (this->_internal_dropped_attributes_count() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        7, this->_internal_dropped_attributes_count(), target);
  }
  ...
  if (this->_internal_observed_time_unix_nano() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFixed64ToArray(
        11, this->_internal_observed_time_unix_nano(), target);
  }
...
void LogRecord::InternalSwap(LogRecord* other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.severity_text_, lhs_arena,
