...
const ::uint32_t TableStruct_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto(&descriptor_table_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto);
namespace opentelemetry {
namespace proto {
namespace common {
namespace v1 {
  ...
  switch (value_case()) {
    case kStringValue: {
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "opentelemetry.proto.common.v1.AnyValue.string_value");
...
::uint8_t* KeyValue::_InternalSerialize(
  ...
  if (!this->_internal_key().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "opentelemetry.proto.common.v1.KeyValue.key");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
...
::uint8_t* InstrumentationScope::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "opentelemetry.proto.common.v1.InstrumentationScope.name");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  if (!this->_internal_version().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "opentelemetry.proto.common.v1.InstrumentationScope.version");
