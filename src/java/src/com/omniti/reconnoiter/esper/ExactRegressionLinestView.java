...
public final class ExactRegressionLinestView extends ExactBaseBivariateStatisticsView implements CloneableView
{
    ...
    public ExactRegressionLinestView(AgentInstanceContext agentInstanceContext, ExprNode xFieldName, ExprNode yFieldName, EventType eventType, StatViewAdditionalProps additionalProps)
    {
    ...
    {
        return new ExactRegressionLinestView(agentInstanceContext, this.getExpressionX(), this.getExpressionY(), eventType, additionalProps);
    }
    ...
    {
        return getEventType(agentInstanceContext.getStatementContext().getEventAdapterService());
    }
