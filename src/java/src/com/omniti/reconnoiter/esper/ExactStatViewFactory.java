...
public class ExactStatViewFactory extends ViewFactorySupport {
    ...
    public View makeView(AgentInstanceViewFactoryChainContext agentInstanceViewFactoryContext) {
        return new ExactRegressionLinestView(agentInstanceViewFactoryContext.getAgentInstanceContext(), timestampExpression, valueExpression, eventType, additionalProps);
    }
