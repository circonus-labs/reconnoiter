...
public class DeriveViewFactory extends ViewFactorySupport {
    ...
    public void attach(EventType parentEventType, 
        ...
        ExprNode[] validatedNodes = ViewFactorySupport.validate("DeriveView", 
    ...
    public View makeView(AgentInstanceViewFactoryChainContext agentInstanceViewFactoryContext) {
        return new DeriveView(agentInstanceViewFactoryContext.getAgentInstanceContext(), timestampExpression, valueExpression, eventType, additionalProps);
    }

    public EventType getEventType() {
        return DeriveView.getEventType(viewFactoryContext.getEventAdapterService());
    }
}
