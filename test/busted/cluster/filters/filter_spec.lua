...
<filterset name="]=] .. name .. [=[" cull="]=] .. cull .. [=[" seq="]=] .. global_filter_seq .. [=[">
  ...
  describe("filter", function()
    ...
    it("has replicated filters across the cluster", function()
      mtev.sleep(5)
      local code  = api1:raw("GET", "/filters/set/basic_cull_true", basic_cull_true_filterset)
      assert.is_equal(200, code)
      code  = api1:raw("GET", "/filters/set/basic_cull_false", basic_cull_false_filterset)
      assert.is_equal(200, code)
      code  = api2:raw("GET", "/filters/set/basic_cull_true", basic_cull_true_filterset)
      assert.is_equal(200, code)
      code  = api2:raw("GET", "/filters/set/basic_cull_false", basic_cull_false_filterset)
      assert.is_equal(200, code)
    end)
  end)
end)
